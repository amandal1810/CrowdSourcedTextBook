...
for($j=0;$j<count($b);$j++)//count is php inbuilt function to get no of elements in an array
{
    ...
    if($start!=$pos['spos'] || $end!=$pos['epos'])
    {
      ...
      if($s=='[Q]')
      {
        echo '<input type="Button" value="Add answer" a href = "javascript:void(0)" onclick = "document.getElementById(';
        echo "'light2').style.display='block';document.getElementById('fade2').style.display='block'";
        echo '"></a>
        <div id="light2" class="white_content2"><br><center>
            <form id="answerform"><center><b>Add your answer</b></center><br>
                <input type="hidden" id="annoid" value="'.$id.'"><br>
                <textarea name="edit" rows="10" cols="50" id="textarea"></textarea><br>
                <input type="button" name="Submit" value="Submit" onclick="postanswer();">

                <input type="button" value="Close" a href = "javascript:void(0)" onclick = "document.getElementById(';
                echo "'light2').style.display='none';document.getElementById('fade2').style.display='none'";
                echo '"></a>
            </form></center>      
